...
namespace HomeExpenses.Infrastructure.Migrations
{
    ...
    [Migration("20180415175247_TenantRepository")]
    partial class TenantRepository
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HomeExpenses.Domain.Bills.Model.Bill", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("HomeExpenses.Domain.Bills.Model.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("HomeExpenses.Domain.Bills.Model.Recipient", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("HomeExpenses.Domain.Bills.Model.Bill", b =>
                {
                    b.HasOne("HomeExpenses.Domain.Bills.Model.Recipient", "Recipient")
                        .WithOne()
                        .HasForeignKey("HomeExpenses.Domain.Bills.Model.Bill", "RecipientId")
                        .OnDelete(DeleteBehavior.Cascade);
                });

            modelBuilder.Entity("HomeExpenses.Domain.Bills.Model.Payment", b =>
                {
                    b.HasOne("HomeExpenses.Domain.Bills.Model.Bill")
                        .WithMany("Payments")
                    ...
                    b.OwnsOne("Core.Domain.ValueObjects.AddressValueObject", "Address", b1 =>
                        {
                            ...
                            b1.HasOne("HomeExpenses.Domain.Bills.Model.Recipient")
                                .WithOne("Address")
