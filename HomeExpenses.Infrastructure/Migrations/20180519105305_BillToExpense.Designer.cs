...
namespace HomeExpenses.Infrastructure.Migrations
{
    ...
    [Migration("20180519105305_BillToExpense")]
    partial class BillToExpense
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HomeExpenses.Domain.Expenses.Model.Recipient", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.OwnsOne("Core.Domain.ValueObjects.AddressValueObject", "Address", b1 =>
                        {
                            ...
                            b1.HasOne("HomeExpenses.Domain.Expenses.Model.Recipient")
                                .WithOne("Address")
            ...
            modelBuilder.Entity("HomeExpenses.Domain.Expenses.Model.ExpenseType.PeriodicExpenseType", b =>
                {
                    b.HasOne("HomeExpenses.Domain.Expenses.Model.Recipient", "Recipient")
                        .WithOne()
                        .HasForeignKey("HomeExpenses.Domain.Expenses.Model.ExpenseType.PeriodicExpenseType", "RecipientId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
